          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <h1 className="reveal delay-100 mt-4 max-w-4xl font-display text-7xl leading-[0.95] md:text-8xl">
                Built for the <span className="shimmer-text">regulated</span> enterprise.
              </h1>
              <p className="reveal delay-200 mt-8 max-w-2xl text-lg text-muted-foreground leading-relaxed mb-8">
                EKABA was designed to pass the same procurement and security reviews you put your
                core systems through. Here's exactly how.
              </p>
              ...
              <div className="reveal delay-300 flex flex-wrap gap-3">
                {["GDPR", "SOC 2 Type II", "ISO 27001", "HIPAA"].map((badge) => (
                  <span
                    key={badge}
                    className="glass-card inline-flex items-center gap-2 rounded-full border border-primary/20 px-4 py-2 text-sm font-mono text-primary"
                  >
      ...
      <section className="border-b border-border/60 bg-secondary/20">
        <div className="mx-auto grid max-w-7xl gap-16 px-6 py-24 md:grid-cols-12">
          <div className="md:col-span-5 reveal-left">
            ...
            <Link
              to="/contact"
              className="mt-8 btn-gradient inline-flex items-center gap-2 rounded-lg px-6 py-3 text-sm font-semibold text-white"
            >
          ...
          <div className="mt-14 overflow-hidden rounded-xl border border-border/60 shadow-xl">
            ...
            {risks.map(([r, m], i) => (
              <div
                ...
                style={{ transitionDelay: `${i * 80}ms` }}
              >
                <div className="col-span-4 font-display text-xl group-hover:text-primary transition-colors">
                  {r}
                </div>
                <div className="col-span-2">
                  <span
                    className={`rounded-md px-2 py-1 font-mono text-[10px] uppercase ${i === 2 ? "bg-amber-500/15 text-amber-400" : "bg-primary/15 text-primary"}`}
                  >
                    {i === 2 ? "Medium" : "High"}
                  </span>
                </div>
