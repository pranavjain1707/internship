  ...
  head: () => ({
    meta: [
      { title: "Platform — EKBA" },
      {
        name: "description",
        content:
          "How EKBA ingests, indexes, and retrieves enterprise knowledge — from document upload to cited response.",
      },
      ...
      <section className="border-b border-border/60">
        <div className="mx-auto max-w-7xl px-6 pb-20 pt-24">
          ...
          <h1 className="mt-6 max-w-4xl font-display text-7xl leading-[0.95]">
            Documents in. <em className="text-primary">Answers out.</em>
          </h1>
          <p className="mt-8 max-w-2xl text-lg text-muted-foreground">
            EKBA is a four-layer system: ingestion, intelligence, retrieval, and interface. Each
    ...
    <section className="border-b border-border/60">
      <div className="mx-auto max-w-7xl px-6 py-24">
        <div className="flex items-end justify-between gap-8">
          <h2 className="max-w-2xl font-display text-5xl leading-tight">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2">
          {caps.map(({ id, icon: Icon, t, d }) => (
            <div
              key={id}
              className="group flex gap-6 rounded-lg border border-border bg-card p-8 transition hover:border-primary/40"
            >
      ...
      <div className="mx-auto grid max-w-7xl gap-16 px-6 py-24 md:grid-cols-12">
        <div className="md:col-span-5">
          ...
          <p className="mt-6 text-muted-foreground">
            Plug EKBA into your existing intranet, Slack workspace, or internal tools. The same
        ...
        <div className="md:col-span-7">
          <div className="overflow-hidden rounded-lg border border-border bg-card font-mono text-sm">
            {eps.map(([m, p, d]) => (
              <div
                key={p}
                className="grid grid-cols-12 items-start gap-4 border-b border-border p-5 last:border-b-0"
              >
                <span className="col-span-2 rounded bg-primary/15 px-2 py-1 text-center text-xs text-primary">
                  {m}
                </span>
