  ...
  const stages = [
    {
      ...
      detail: "parsing HR_Handbook_2025.pdf",
      file: "HR_Handbook.pdf",
    },
    {
      label: "Chunk & Segment",
      detail: "creating semantic windows (512 tokens)",
      file: "512_tokens_window.json",
    },
    {
      label: "Embedding Conversion",
      detail: "generating 1536-dimensional vectors",
      file: "text-embedding-3",
    },
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span
                      className={`h-2 w-2 rounded-full ${isActive ? "bg-primary animate-ping" : "bg-muted-foreground"}`}
                    />
                ...
                {isActive && (
                  <div className="mt-2 text-[10px] text-muted-foreground leading-relaxed animate-fade-in pl-4 border-l border-primary/30 space-y-1">
                    ...
                    <div className="text-[8px] text-primary/80 font-mono">
                      FILE REF: {stage.file}
                    </div>
                  </div>
                )}
  ...
  head: () => ({
    meta: [
      { title: "Platform — EKABA" },
      {
        name: "description",
        content:
          "How EKABA ingests, indexes, and retrieves enterprise knowledge — from document upload to cited response.",
      },
      { property: "og:title", content: "Platform — EKABA" },
      {
        property: "og:description",
        content:
          "Functional and architectural overview of the Enterprise Knowledge Base Assistant.",
      },
    ],
  }),
  component: Platform,
  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden border-b border-border/60 min-h-[55vh] flex items-center">
        ...
        <div
          className="absolute right-1/4 top-1/3 h-[200px] w-[200px] rounded-full"
          style={{
            background: "radial-gradient(circle, oklch(0.62 0.16 40 / 12%), transparent 70%)",
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-24 pt-28 w-full">
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <h1 className="reveal delay-100 mt-4 max-w-4xl font-display text-7xl leading-[0.95] md:text-8xl">
                Documents in. <span className="shimmer-text">Answers out.</span>
              </h1>
              <p className="reveal delay-200 mt-8 max-w-2xl text-lg text-muted-foreground leading-relaxed">
                EKABA is a four-layer system: ingestion, intelligence, retrieval, and interface.
                Each layer is modular, replaceable, and built for enterprise scale.
              </p>
            </div>
          ...
          <div className="reveal delay-300 mt-14 grid grid-cols-2 gap-px overflow-hidden rounded-xl border border-border/60 bg-border/40 md:grid-cols-4 shadow-xl">
            {[
              ...
              <div
                key={l}
                className="bg-background/80 backdrop-blur-sm p-6 group hover:bg-secondary/30 transition-colors"
              >
  ...
  const caps = [
    {
      ...
      icon: UserCheck,
      t: "Authentication",
      d: "OAuth 2.0, SAML SSO, multi-factor auth, and role-based scope from day one.",
    },
    {
      id: "FR-02",
      icon: Search,
      t: "Knowledge search",
      d: "Hybrid keyword + semantic ranking. Search by phrase, question, or vague intent.",
    },
    {
      id: "FR-03",
      icon: MessageSquare,
      t: "Conversational assistant",
      d: "Multi-turn context, follow-ups, and conversational memory scoped to your role.",
    },
    {
      id: "FR-04",
      icon: Upload,
      t: "Document ingestion",
      d: "Drop in PDFs, DOCX, PPTX, TXT. Chunked, embedded, and indexed automatically.",
    },
    {
      id: "FR-05",
      icon: FileText,
      t: "Source citation",
      d: "Every answer is anchored to a document, page, and section. Auditable by design.",
    },
    {
      id: "FR-06",
      icon: ThumbsUp,
      t: "Feedback loop",
      d: "Thumbs, reports, and review queues feed back into ranking and fine-tuning.",
    },
  ];
  return (
        ...
        <div className="reveal flex items-end justify-between gap-8">
          <div>
            ...
            <h2 className="mt-6 max-w-2xl font-display text-5xl leading-tight">
              Functional requirements, productized.
            </h2>
          </div>
          <span className="hidden font-mono text-xs text-muted-foreground md:inline">
            6 capabilities · MVP scope
          </span>
        </div>
            ...
            >
              ...
              <div className="relative flex-1">
                <div className="flex items-center gap-3">
                  ...
                  <span className="rounded border border-primary/30 bg-primary/10 px-1.5 py-0.5 font-mono text-[9px] uppercase tracking-wider text-primary">
                    High
                  </span>
                </div>
                <h3 className="mt-3 font-display text-3xl group-hover:text-primary transition-colors">
                  {t}
                </h3>
  ...
  const layers = [
    {
      ...
      n: "Frontend",
      t: ["React.js", "Next.js"],
      d: "Chat interface, dashboard, admin panel. Fast, accessible, mobile-ready.",
    },
    {
      icon: Server,
      n: "Backend",
      t: ["Python", "FastAPI"],
      d: "API gateway, authentication, orchestration. Modular service boundaries.",
    },
    {
      icon: MessageSquare,
      n: "AI Layer",
      t: ["LLM", "Embeddings", "RAG engine"],
      d: "Retrieval-augmented generation with grounded context and source attribution.",
    },
    {
      icon: Database,
      n: "Database",
      t: ["PostgreSQL", "Vector DB"],
      d: "Structured records, embeddings, audit logs, and granular access policies.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-6 py-24">
        <div className="reveal">
          ...
          <h2 className="mt-6 max-w-3xl font-display text-5xl leading-tight">
            Four layers. Clean contracts. Independently scalable.
          </h2>
        </div>
              ...
              <div className="col-span-12 md:col-span-3">
                <div className="flex flex-wrap gap-1.5">
                  {t.map((tech) => (
                    <span
                      key={tech}
                      className="rounded-md border border-border/60 bg-secondary/60 px-2 py-1 font-mono text-xs text-muted-foreground"
                    >
                      {tech}
                    </span>
                  ))}
      ...
      <div className="mx-auto grid max-w-7xl gap-16 px-6 py-24 md:grid-cols-12">
        <div className="md:col-span-5 reveal-left">
          ...
          <h2 className="mt-6 font-display text-5xl leading-tight">
            Four endpoints. Everything else is implementation detail.
          </h2>
          ...
          <Link
            to="/contact"
            className="mt-8 inline-flex items-center gap-2 btn-gradient rounded-lg px-6 py-3 text-sm font-semibold text-white"
          >
          ...
          <div className="card-3d overflow-hidden rounded-xl border border-border/60 bg-card font-mono text-sm shadow-2xl">
            ...
            {eps.map(([m, p, d], i) => (
              <div
                ...
                style={{ transitionDelay: `${i * 80}ms` }}
              >
                <span className="col-span-2 rounded-md bg-primary/15 px-2 py-1 text-center text-xs text-primary font-semibold">
                  {m}
                </span>
                <code className="col-span-3 text-foreground group-hover:text-primary transition-colors">
                  {p}
                </code>
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-4xl px-6 py-32 text-center">
        ...
        <h2 className="reveal delay-100 font-display text-5xl leading-tight md:text-6xl">
          Want a deeper <span className="shimmer-text">technical walkthrough?</span>
        </h2>
        <p className="reveal delay-200 mx-auto mt-6 max-w-xl text-muted-foreground leading-relaxed">
          Our solution engineers will run through the architecture, security model, and ingestion
          pipeline against your own stack.
        </p>
